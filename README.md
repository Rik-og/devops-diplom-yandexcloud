...
![monitoring](https://github.com/12oleg12/Diplom/blob/main/images/%D0%BE%D0%B1%D1%89%D0%B8%D0%B9%20%D0%B2%D0%B8%D0%B4.yc.png)
...
```
root@oleg:/home/oleg/DIPLOM/terraform_2/terraform# terraform apply -auto-approve
...
```
root@oleg:/home/oleg/kubespray# ansible-playbook -i inventory/mycluster/hosts.yaml cluster.yml -b
...
2. Регистри с собранным docker image. В качестве регистри может быть
 ...
 [DockerHub](https://hub.docker.com/layers/oleg/myapp/0.0.1/images/sha256-1b56d3e635fdee5beb3e8d16edac61d0ef3cb009f722357618b7c755048d53b8?context=repo) или [Yandex Container Registry](https://cloud.yandex.ru/services/container-registry), созданный также с помощью terraform.

В целях проверки работоспособности соберем образ:

```
root@oleg:/home/oleg/myapp# docker build --build-arg VEESION=v0.0.3 -t 12sergey12/myapp:0.0.3 .
...
```
root@oleg:/home/oleg/myapp# docker images
REPOSITORY         TAG       IMAGE ID       CREATED       SIZE
oleg/myapp   0.0.3     d6ad24ec1b14   4 hours ago   142MB
root@baranovsa:/home/oleg/myapp# 
```
![monitoring](https://github.com/oleg/Diplom/blob/main/images/idevops.png)
...
![monitoring](https://github.com/oleg/Diplom/blob/main/images/grafana.png)

![monitoring](https://github.com/oleg/Diplom/blob/main/images/prometheus.png)
...
![monitoring](https://github.com/oleg/Diplom/blob/main/images/github_action.png)

2. При любом коммите в репозиторие с тестовым приложением происходит сборка и отправка в регистр Docker образа.


[production_deployment.yml](https://github.com/oleg/Diplom/blob/main/myapp/.github/workflows/production_deployment.yml)
```
name: myapp
on:
  push:
...
![monitoring](https://github.com/oleg/Diplom/blob/main/images/ci_cd.png)

![monitoring](https://github.com/oleg/Diplom/blob/main/images/dockerhub(1).png)
